...
public class RequestListFactoryImpl implements RequestListFactory {
    ...
    /**
     * Filtrera svarsposter från engagemangsindexet baserat parametrar i GetCareDocumentation requestet. 
    ...
    public List<Object[]> createRequestList(QueryObject qo, FindContentResponseType findContentResponse) {
        ...
        GetCareDocumentationType request = (GetCareDocumentationType) qo.getExtraArg();
