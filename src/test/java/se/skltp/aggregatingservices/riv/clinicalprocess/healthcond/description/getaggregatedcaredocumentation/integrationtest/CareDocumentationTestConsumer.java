...
public class CareDocumentationTestConsumer extends AbstractTestConsumer<GetCareDocumentationResponderInterface>{
    ...
    public static void main(String[] args) {
        ...
        CareDocumentationTestConsumer consumer = new CareDocumentationTestConsumer(serviceAddress);
    ...
    public CareDocumentationTestConsumer(String serviceAddress) {
        // Setup a web service proxy for communication using HTTPS with Mutual Authentication
        super(GetCareDocumentationResponderInterface.class, serviceAddress); 
    }
