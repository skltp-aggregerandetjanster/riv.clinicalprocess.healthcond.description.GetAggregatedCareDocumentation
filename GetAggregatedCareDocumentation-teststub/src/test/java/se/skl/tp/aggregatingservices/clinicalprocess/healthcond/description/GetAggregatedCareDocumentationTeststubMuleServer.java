package se.skl.tp.aggregatingservices.clinicalprocess.healthcond.description;
...
public class GetAggregatedCareDocumentationTeststubMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedCareDocumentation-teststub";
 

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedCareDocumentationTeststubMuleServer.class);
